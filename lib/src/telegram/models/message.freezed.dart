...
mixin _$Message {
  ...
  /// Optional. Unique identifier of the guest query. Present only in guest
  /// messages. The bot can use this to answer the query using answerGuestQuery.
